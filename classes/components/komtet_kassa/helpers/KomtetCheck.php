...
class KomtetCheck
{
     ...
     * @param string $intent KomtetCheck::INTENT_SELL or KomtetCheck::INTENT_SELL_RETURN
     * @param int    $taxSystem See KomtetCheck::TS_*
     *
     * @return KomtetCheck
     */
    ...
    /**
     * @param KomtetPayment $payment
     *
     * @return KomtetCheck
     */
    public function addPayment(KomtetPayment $payment)
    {
    ...
    /**
     * @param KomtetPosition $position
     *
     * @return KomtetCheck
     */
    public function addPosition(KomtetPosition $position)
    {
